      ...
      <div className="w-72 bg-black h-screen shadow-md flex flex-col justify-between">
        ...
        <div>
          ...
          <div className="flex flex-col px-6 mt-8 divide-y divide-gray-300 text-lg text-gray-100 font-medium">
            <Link href="/dashboard" className="py-4 hover:text-blue-300">Dashboard</Link>
            <Link href="/dashboard?view=myprojects" className="py-4 hover:text-blue-300">My Projects</Link>
            <Link href="/dashboard?view=created" className="py-4 hover:text-blue-300">My Created Projects</Link>
            <Link href="/members" className="py-4 hover:text-blue-300">Members</Link>
            <Link href="/myprofile" className="py-4 hover:text-blue-300">My Profile</Link>
            <Link href="/settings" className="py-4 hover:text-blue-300">Settings</Link>
          </div>
        </div>
